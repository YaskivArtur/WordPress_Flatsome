...
add_filter('the_content', 'convert_absolute_to_relative_urls');

// Function to convert absolute URLs to relative URLs
function convert_absolute_to_relative_urls($content) {
    // Replace absolute URLs with relative URLs in post content
    $content = str_replace('https://www.example.com', '', $content);
